...
Similarly, ``asdf/block.h`` exposes a lower-level API for reading and writing
ASDF binary blocks directly, rather than through the ``core/ndarray``
interface.  It too is aimed at advanced use and is not yet documented here.
